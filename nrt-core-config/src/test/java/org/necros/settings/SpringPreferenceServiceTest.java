...
@ContextConfiguration(locations="classpath*:META-INF/config-beans.xml")
public class SpringPreferenceServiceTest {
	private static final Logger logger = LoggerFactory.getLogger(SpringPreferenceServiceTest.class);
	...
	public void testGetPreference() throws PreferenceException {
		...
		String v = p.getValue();
		assertNotNull(v);
		assertTrue(v.equals("test-preferences.properties"));
